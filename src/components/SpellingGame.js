...
const SpellingGame = ({ navigation }) => {
  ...
  useEffect(() => {
    const loadSounds = async () => {
      try {
        const { sound: correct } = await Audio.Sound.createAsync(require("../../assets/sounds/correct.wav"))
        const { sound: incorrect } = await Audio.Sound.createAsync(require("../../assets/sounds/incorrect.mp3"))
